...
(function (wid, dcm) {
    ...
    MultiPicker.prototype = {
        ...
        initDomFuc: function () {
            var _this                      = this;
            var html                       = '';
            var container='',proAndcity='',content='';
            // console.log(_this.flag)
            if(_this.flag == true){
                container = '<div  class="multi-picker-container" id="multi-picker-container-' + _this.container + '">';
                proAndcity='';
                content = '<div class="multi-picker-content">'
            }else if(_this.flag == false){
                container = '<div  class="multi-picker-container" id="multi-picker-container-' + _this.container + '" style="height: 400px">'
                proAndcity = '<div class="multi-picker-info-box"><div class="province">省份</div><div class="city">城市</div></div>';
                content = '<div class="multi-picker-content" style="top: 150px;">'
            }
            html += '<div class="multi-picker-bg" id="multi-picker-bg-' + _this.container + '">'
                ...
                + '</div></div></div>';
            // console.log($(_this.container) ,$id(_this.container));
        ...
        initBinding: function () {
            ...
            on('touchstart', 'multi-picker-btn-save-' + _this.container, function (e) {
                e.preventDefault();
                e.stopPropagation();
            ...
            on('touchstart', 'multi-picker-bg-' + _this.container, function (e) {
                e.preventDefault();
                e.stopPropagation();
                bg.classList.remove('multi-picker-bg-up');
                container.classList.remove('multi-picker-container-up');
            ...
            on('touchstart', 'multi-picker-btn-cancel', function (e) {
                e.preventDefault();
                e.stopPropagation();
                bg.classList.remove('multi-picker-bg-up');
                container.classList.remove('multi-picker-container-up');
                body.classList.remove('multi-picker-locked');
                $(".address_detail_modal").css({"display":"none"});
            }, false);
            on('touchstart','address_detail_cancel',function (e) {
                e.preventDefault();
                e.stopPropagation();
                bg.classList.add('multi-picker-bg-up');
                container.classList.add('multi-picker-container-up');
