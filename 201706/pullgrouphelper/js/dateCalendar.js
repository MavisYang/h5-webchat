...
window.LCalendar = (function() {
    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            var _self = this;
            //触发其他位置弹框隐藏
            $("body").on("touchstart",".gearDate",function (e) {
                e.stopPropagation();
                var _con = $(".date_ctrl");   // 设置目标区域
            ...
            function finishMobileDate(e) {
                ...
                $("#predateSelect span").text(_self.trigger.value);
                closeMobileCalendar(e);
            }
            //年月确认
            ...
            //解决ios中input获得焦点时软键盘弹出的问题
            _self.trigger.addEventListener("focus",function () {
                _self.trigger.blur();
            });
        }
    }
